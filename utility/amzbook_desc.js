...
if (options.asin) {
            ...
            if (body.result === 'ok') {
                if (body.books.length > 0) {
                    ...
                    if (options.test)
                        ...
                        // 更新処理
                        casper.open('http://127.0.0.1:8080/book/update/' + book._id, {
                            headers: {
                                'Accept': 'application/json'
                            },
                            method: 'post',
    ...
    console.log('使用例：');
    console.log('casperjs amzbook_desc.js --asin=4873116457');
    console.log('casperjs amzbook_desc.js --asin=4873116457 --test');
    casper.exit();
}