...
describe('Book', function () {
    ...
    it('Book1を作成したいですが、タイトル未入力のため失敗しました', function (done) {
        common.gapi.book.create({}, function (err, res, body) {
    ...
    it('Book2を作成しました', function (done) {
        common.gapi.book.create({
            title: 'book-title-2'
            ...
            if (err) console.error(err);
                ...
                //console.log(body);
                common.gapi.book.find(body.book._id, function (err, res, body) {
                    body.result.should.equal('ok');
                    body.book.title.should.equal('book-title-2');
                    done();
                });
        ...
        common.gapi.book.create({
            ...
            if (err) console.error(err);
                ...
                common.gapi.book.find(body.book._id, function (err, res, body) {
                    ...
                    body.book.status.should.equal('book-status-3');
                    body.book.meta.should.equal('book-meta-3');
                    common.gapi.book.update(body.book._id, {
